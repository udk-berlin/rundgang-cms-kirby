...
//
$context_json = asset('assets/2026/contexts.json')->read();
...
//
$format_json = asset('assets/2026/formats.json')->read();
            ...
            'columns' => [
                ...
                'metadata_column_main' => [
                    ...
                    'sections' => [
                        ...
                        #            'options' => [
                        #                'type' => 'api',
                        #                'url' => 'assets/2026/locations.json',
                        ...
                        'event_section' => [
                            ...
                            'fields' => [
                                ...
                                'event_field_date_time_friday_times' => [
                                    'type' => 'structure',
                                    'label' => [
                                        'en' => 'Timetable for Friday, July 17',
                                        'de' => 'Zeitplan für Freitag, 17. Juli',
                                    ],
                                    'required' => true,
                                    'translate' => false,
                                    'when' => [
                                    ...
                                    'fields' => [
                                        ...
                                        'event_structure_field_friday_info' => [
                                            ...
                                            'text' => [
                                                ...
                                                'de' => 'Bitte prüfen Sie <a href="https://www.udk-berlin.de/rundgang/2026/orte-und-oeffnungszeiten/" target="_blank">Orte und Öffnungszeiten</a> für geltende Start- und Endzeiten.',
                                            ],
                                            'theme' => 'info',
                                        ],
                                ...
                                'event_field_date_time_saturday_times' => [
                                    'type' => 'structure',
                                    'label' => [
                                        'en' => 'Timetable for Saturday, July 18',
                                        'de' => 'Zeitplan für Samstag, 18. Juli',
                                    ],
                                    'required' => true,
                                    'translate' => false,
                                    'when' => [
                                ...
                                'event_field_date_time_sunday_times' => [
                                    'type' => 'structure',
                                    'label' => [
                                        'en' => 'Timetable for Sunday, July 19',
                                        'de' => 'Zeitplan für Sonntag, 19. Juli',
                                    ],
                                    'required' => true,
                                    'translate' => false,
                                    'when' => [
