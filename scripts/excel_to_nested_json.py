...
def process_sheet(
    ...
    faculty_data = {"name": faculty_name, "type": "faculty", "institutes": []}
    ...
    if faculty_col and len(df[faculty_col].dropna().unique()) > 1:
        ...
        for faculty_name in faculties:
            ...
            if institute_col:
                process_institutes(
                    faculty_df, institute_col, course_col, class_col, current_faculty
                )
...
def process_institutes(df, institute_col, course_col, class_col, faculty_data):
    ...
    if institute_col in df.columns:
        ...
        if not missing_institute_df.empty and course_col:
            ...
            process_courses(
                missing_institute_df, course_col, class_col, missing_institute
            )
...
def process_courses(df, course_col, class_col, institute_data):
    ...
    if course_col in df.columns:
        ...
        for course_name in courses:
            course_data = {"name": course_name, "type": "course", "classes": []}
        ...
        default_course = {"name": "Default Course", "type": "course", "classes": []}
...
def excel_to_nested_json(
    ...
    result = {"name": university_name, "type": "institution", "faculties": []}
